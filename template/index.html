...
<head lang="en">
    ...
    <script type="text/javascript" src="http://valentinowechat.samesamechina.com/api/v1/js/80c73ea5-de82-4aff-98ff-fd79aad6041d/wechat?debug=1"></script>
    <script src="/src/assets/js/lib/zepto.min.js"></script>
    <script src="/src/assets/js/lib/pre-loader.js"></script>
    <script src="/src/assets/js/lib/reqAnimate.js"></script>
...
<div class="wrapper">
    <div class="container">
        <!-- landing page-->
        <div class="pin pin-1 current" id="landing-page">
            <div class="layer-bg">
                <div class="lbg bg-1">
                    <div class="color-area orange"></div>
                    <div class="pipe">
                        <img src="/src/dist/images/pipe-2.png" alt=""/>
                    </div>
                </div>
                <div class="lbg bg-2">
                    <div class="color-area blue"></div>
                    <div class="pipe">
                        <img src="/src/dist/images/pipe-1.png" alt=""/>
                    </div>
                </div>
            </div>
            <div class="content">
                <div class="logo">
                    <img src="/src/dist/images/logo.png" alt="valentino"/>
                </div>
                <div class="p1-t1">
                    <img src="/src/dist/images/p1-t1.png" alt="精致刺绣，魅惑无限"/>
                </div>
                <div class="video-block">
                    <video src="/src/dist/video/test.mp4"  poster="/src/dist/images/poster.jpg">
                ...
                <div class="btn btn-start-custom">
                    ...
                    <div class="text">
                        <img src="/src/dist/images/btn-text-1.png" alt="valentino"/>
                    </div>
                </div>
            </div>
        </div>
        <!-- select straps style, then custom the words with two-->
        <div class="pin pin-2" id="select-page">
            ...
            <div class="switch-menu">
                ...
                <div class="step step-2">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" class="input-custom" maxlength="2" placeholder="请在此输入两个字母"/>
                        <div class="btn btn-finish control">完成</div>
                    </div>
                </div>
            </div>
        </div>
