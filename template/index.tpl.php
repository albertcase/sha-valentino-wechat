...
<head lang="en">
    ...
    <script type="text/javascript" src="http://valentinowechat.samesamechina.com/api/v1/js/65454635-a701-4ea4-b7f5-5cebae7e6674/wechat"></script>
    <script src="/src/dist/js/all_home.min.js?v=4"></script>
</head>
        ...
        <div class="pin pin-1 current" id="landing-page">
            ...
            <div class="content">
                ...
                <div class="btn btn-start-custom">
                    ...
                    <div class="text">
                        <img src="/src/dist/images/text-custom.png" alt="valentino"/>
                    </div>
                </div>
            </div>
        </div>
